...
@section('content')
    ...
    <div class="page-body">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <form method="post" action="{{ CommonHelper::admin('cms/home-product-sliders') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <tbody>
                                @foreach ($list as $key => $value)
                                    <tr>    
                                        ...
                                        <td>{{ $value->sort }}</td>
                                        <td class="text-center">
                                            <a href="{{ CommonHelper::admin('cms/home-product-sliders/'.encrypt($value->id)) }}" class="btn btn-danger btn-mini btn-delete" title="Delete">
