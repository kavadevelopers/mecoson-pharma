							...
							<div class="col-md-6">
								<div class="fbox-5 fb-1 bg--white-400 r-16 wow fadeInUp">
									...
									<div class="fbox-5-img order-first order-md-2">
										<img class="img-fluid" src="{{ url('themes/pharma/images/f_06.png') }}" alt="feature-image">
									</div>
							...
							<div class="col-md-6">
								<div class="fbox-5 fb-2 bg--white-400 r-16 wow fadeInUp">
									...
									<div class="fbox-5-img">
										<img class="img-fluid" src="{{ url('themes/pharma/images/f_04.png') }}" alt="feature-image">
									</div>
			...
			<section id="lnk-2" class="pt-100 ct-02 content-section division">
				<div class="container">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="img-block left-column wow fadeInRight">
								<img class="img-fluid" src="{{ url('themes/pharma/images/img-03.png') }}" alt="content-image">
							</div>
						</div>
			...
			<section class="py-100 ct-02 content-section division">
				<div class="container">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="img-block left-column wow fadeInRight">
								<img class="img-fluid" src="{{ url('themes/pharma/images/img-02.png') }}" alt="content-image">
							</div>
						</div>
						...
						<div class="row">	
							<div class="col">
								<div class="img-block video-preview wow fadeInUp">
									...
									<!-- Preview Image --> 
				 					<img class="img-fluid" src="{{ url('themes/pharma/images/dashboard-01.png') }}" alt="video-preview">
						...
						<div class="col text-center">	
							<div class="owl-carousel brands-carousel-5">
								...
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="{{ url('themes/pharma/images/brand-1.png') }}" alt="brand-logo"></a>
								</div>

													
								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="{{ url('themes/pharma/images/brand-2.png') }}" alt="brand-logo"></a>
								</div>

													
								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="{{ url('themes/pharma/images/brand-3.png') }}" alt="brand-logo"></a>
								</div>

													
								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="{{ url('themes/pharma/images/brand-4.png') }}" alt="brand-logo"></a>
								</div>

													
								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="{{ url('themes/pharma/images/brand-5.png') }}" alt="brand-logo"></a>
								</div>

													
								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="{{ url('themes/pharma/images/brand-6.png') }}" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="{{ url('themes/pharma/images/brand-7.png') }}" alt="brand-logo"></a>
								</div>

															
								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="{{ url('themes/pharma/images/brand-8.png') }}" alt="brand-logo"></a>
								</div>

								
								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="{{ url('themes/pharma/images/brand-9.png') }}" alt="brand-logo"></a>
								</div>
			...
			<section class="pt-100 ct-01 content-section division">
				<div class="container">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6 order-first order-md-2">
							<div class="img-block right-column wow fadeInLeft">
								<img class="img-fluid" src="{{ url('themes/pharma/images/img-13.png') }}" alt="content-image">
							</div>
						</div>
					...
					<div class="row">	
						<div class="col">
							<div class="img-block wow fadeInUp">
			 					<img class="img-fluid" src="{{ url('themes/pharma/images/img-19.png') }}" alt="video-preview">
							</div>
						</div>
					</div>
			...
			<section class="py-100 ct-02 content-section division">
				<div class="container">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="img-block left-column wow fadeInRight">
								<img class="img-fluid" src="{{ url('themes/pharma/images/img-09.png') }}" alt="content-image">
							</div>
						</div>
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<div class="review-avatar">
												<img src="{{ url('themes/pharma/images/review-author-1.jpg') }}" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="{{ url('themes/pharma/images/review-author-2.jpg') }}" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="{{ url('themes/pharma/images/review-author-3.jpg') }}" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="{{ url('themes/pharma/images/review-author-4.jpg') }}" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="{{ url('themes/pharma/images/review-author-5.jpg') }}" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="{{ url('themes/pharma/images/review-author-6.jpg') }}" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="{{ url('themes/pharma/images/review-author-7.jpg') }}" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="{{ url('themes/pharma/images/review-author-8.jpg') }}" alt="review-avatar">
											</div>
						...
						<div class="row justify-content-md-center row-cols-1 row-cols-md-3">
							...
							<div class="col">
								<div id="rb-1-1" class="rbox-1">
									...
									<div class="rbox-1-img">
										<img class="img-fluid" src="{{ url('themes/pharma/images/brand-21.png') }}" alt="feature-image">
									</div>
							...
							<div class="col">
								<div id="rb-1-2" class="rbox-1">
									...
									<!-- Brand Logo -->
									<div class="rbox-1-img">
										<img class="img-fluid" src="{{ url('themes/pharma/images/brand-22.png') }}" alt="feature-image">
									</div>
							...
							<div class="col">
								<div id="rb-1-3" class="rbox-1">
									...
									<!-- Brand Logo -->
									<div class="rbox-1-img">
										<img class="img-fluid" src="{{ url('themes/pharma/images/brand-23.png') }}" alt="feature-image">
									</div>
							...
							<!-- TOOL #1 -->
		 					<div class="col">
		 						<a href="#" class="in_tool it-1 r-12 wow fadeInUp">
									...
									<div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
										<img class="img-fluid" src="{{ url('themes/pharma/images/png_icons/tool-1.png') }}" alt="brand-logo">
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-2 r-12 wow fadeInUp">
									...
									<!-- Logo -->
									<div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
										<img class="img-fluid" src="{{ url('themes/pharma/images/png_icons/tool-2.png') }}" alt="brand-logo">
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-3 r-12 wow fadeInUp">
		 							...
		 							<!-- Logo -->
									<div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
										<img class="img-fluid" src="{{ url('themes/pharma/images/png_icons/tool-3.png') }}" alt="brand-logo">
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-4 r-12 wow fadeInUp">
		 							...
		 							<!-- Logo -->
									<div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
										<img class="img-fluid" src="{{ url('themes/pharma/images/png_icons/tool-4.png') }}" alt="brand-logo">
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-5 r-12 wow fadeInUp">
		 							...
		 							<!-- Logo -->
									<div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
										<img class="img-fluid" src="{{ url('themes/pharma/images/png_icons/tool-5.png') }}" alt="brand-logo">
									</div>
